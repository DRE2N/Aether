 ...
 */
public enum UpdatedDefaultFontInfo {
    A('A', 5),
    a('a', 5),
    B('B', 5),
    b('b', 5),
    ...
    UpdatedDefaultFontInfo(char character, int length) {
     ...
     */
    public static UpdatedDefaultFontInfo getDefaultFontInfo(char c) {
        for (UpdatedDefaultFontInfo dFI : values()) {
    ...
    public static Component center(Component message) {
        return UpdatedMessageUtil.parse(center(UpdatedMessageUtil.serialize(message)));
    }
    ...
    public static String getCenterSpaces(String message) {
        ...
        for (char c : UpdatedMessageUtil.stripTokens(message).toCharArray()) {
            if (c == '\u00A7') {
                previousCode = true;
                ...
                UpdatedDefaultFontInfo dFI = getDefaultFontInfo(c);
